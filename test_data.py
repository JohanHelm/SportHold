...
async def add_test_data():
    async with AsyncSession(engine) as session:
        ...
        user_2 = User(
            id=103272, username="@telegram_test_user_2", fullname="Ivan Drago"
        )
        rental = Rental(
        ...
        policy = Policy(book_limit_days=2, need_user_phone=False, need_confirm=False)

        policy.rental = rental
        ...
        )  # record, record_2, tarif1, promo_test, income1, order1, ))
